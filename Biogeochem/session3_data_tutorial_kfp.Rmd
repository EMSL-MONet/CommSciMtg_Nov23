...
```{r pca_function, eval=FALSE, echo=FALSE}
...
```{r pca, fig.height=10, fig.width=12, eval=FALSE, echo=FALSE}
...
plot_texture = function(texture_processed){
  ...
  gg_texture = 
    ...
    geom_point(aes(fill = biome_name),
               size = 4, color = "black", stroke = 1, shape = 21)+
#    facet_wrap(~Location)+
    theme_bw()+
    theme_showarrows()+
    theme_hidetitles()+
    theme_clockwise() +
      scale_fill_manual(values = soil_palette("redox2", 5))+
